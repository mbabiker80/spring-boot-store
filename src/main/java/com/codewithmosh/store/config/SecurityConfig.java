...
public class SecurityConfig {
	...
	public PasswordEncoder passwordEncoder() {
		return new BCryptPasswordEncoder(); //most secure and recommended hashing algorithm
	}
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		// Disable CSRF (cross-side request forgery)
		// Authorize
		...
		http
			.sessionManagement( c ->
				...
				// 401 unauthorized better than 403 vorbidden
				.exceptionHandling(c->{
